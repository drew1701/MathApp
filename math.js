...
$(document).ready($(function() {
    $(".current_page").hide()
    document.getElementById("c_input").innerHTML = "Press Go to begin"
    ...
    $('#c_stop').click(function() {
        ...
        document.getElementById("c_input").innerHTML = `<table><caption>Good Job!</caption><tr><td>Total Question:</td><td>${total_ques}</td></tr> <tr><td>Correct:</td><td>${correct_ques}</td></tr> <tr><td>Time:</td><td>${time} s</td></tr></table>`
    })
...
function generateQuestion(n) {
    ...
    document.getElementById("c_input").innerHTML = ques
    generateOption()
